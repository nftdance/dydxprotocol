...
type MsgSlashValidator struct {
	...
	// this.
	TokensAtInfractionHeight github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=tokens_at_infraction_height,json=tokensAtInfractionHeight,proto3,customtype=github.com/nftdance/dydxprotocol/dtypes.SerializableInt" json:"tokens_at_infraction_height"`
