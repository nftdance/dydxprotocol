...
type PerpetualPosition struct {
	...
	QuoteBalance github_com_dydxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=quote_balance,json=quoteBalance,proto3,customtype=github.com/nftdance/dydxprotocol/dtypes.SerializableInt" json:"quote_balance"`
}
